...
{
	short int T00 = (((short int)WB[0][0] << 1) + (short int)WB[0][0]);
	short int T01 = (((short int)WB[0][2] << 1) + (short int)WB[0][2]);
	short int M00 = (((short int)WB[1][0] << 3) + ((short int)WB[1][0] << 1));
	short int M01 = (((short int)WB[1][2] << 3) + ((short int)WB[1][2] << 1));
	short int B00 = (((short int)WB[2][0] << 1) + (short int)WB[2][0]);
	short int B01 = (((short int)WB[2][2] << 1) + (short int)WB[2][2]);
	
	short int out_pix;
	out_pix = T01 - T00;
	out_pix = out_pix + M01 - M00;
	out_pix = out_pix + B01 - B00;
...
{
	short int L00 = (((short int)WB[0][0] << 1) + (short int)WB[0][0]);
	short int L01 = (((short int)WB[2][0] << 1) + (short int)WB[2][0]);
	short int M00 = (((short int)WB[0][1] << 3) + ((short int)WB[0][1] << 1));
	short int M01 = (((short int)WB[2][1] << 3) + ((short int)WB[2][1] << 1));
	short int R00 = (((short int)WB[0][2] << 1) + (short int)WB[0][2]);
	short int R01 = (((short int)WB[2][2] << 1) + (short int)WB[2][2]);
	
	short int out_pix;
	out_pix = L01 - L00;
	out_pix = out_pix + M01 - M00;
	out_pix = out_pix + R01 - R00;
...
#pragma HLS pipeline
			...
			_scharr = scharr3x3_kernel(WindowBuffer);
